...
import top.kkoishi.dds.decode.compress.DXGIBCUtils.DXGI_FORMAT_BC3_DXT5_BLOCK_SIZE_BYTES

/**
 * The decoder for BC3/DXT5 compressed dds pixels data.
 *
 ...
 */
class DXT5DDSDecoder(dds: DDSRef) : AbstractDXTDDSDecoder(dds, DXGI_FORMAT_BC3_DXT5_BLOCK_SIZE_BYTES) {
    override fun decodeDataLine(): IntArray {
        ...
        if (subLine == 0) {
            ...
            for (index in 0 until blockWidth)
                DXGIBCUtils.decompressBC3DXT5DataBlock(blocksLineCache, index * blockByteSize, blocksCache, index * 16)
        }
